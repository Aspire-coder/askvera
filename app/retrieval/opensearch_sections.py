...
class OpenSearchSectionProvider:
    ...
    def _select_evidence_rows(
        ...
        system_prompt = (
            ...
            "A candidate whose entire text states that a numbered section was deleted, removed, reserved, renumbered, "
            "or left intentionally blank IS a direct answer to a question asking what that section contains or says - "
            "the deletion notice is the section's real, complete content, not missing evidence. Select it, and if it "
            "also names a different title printed for that same section on the document's own contents page, that "
            "stated mismatch is part of what the candidate directly answers too. "
