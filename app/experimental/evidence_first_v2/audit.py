...
_MILESTONE_SERIALIZATIONS=(("backslash","path_hash",1,False),("backslash","path_hash",1,False),("candidate_forward","hash_path",2,False),("forward","hash_path",2,False),("forward","hash_path",2,True),("forward","hash_path",2,True))
_ACCEPTED_AGGREGATES=("2afe5baa9d36f70bbed00d2620f864d783298a356bc2c773eb89d286cd8c14d4","d1702e1aea485a7871e9bdb475a4af61442f4e51d7bb12241d7e1d2eb382c1af","ce680472590455d82f3f933d028f344d7e2b07db694afe5a680af3c2e100809e","17bee0133edef910dddb92edd9b89709756a2d6d4605b36b73bf6ddb99edcf8e","b0075ecd31e25395b8c51b57db6a8cf5aad8183fb3dc77d84993efd2fc75999c","e4dbcb64540bf400631050559dff011841004650253b377e41534054935cce3a")
...
_MANIFEST_LENGTHS=(6,6,3,3,5,5)
_SERIALIZATION_RULES=(("backslash","path_hash",1,False),("backslash","path_hash",1,False),("candidate_forward","hash_path",2,False),("forward","hash_path",2,False),("forward","hash_path",2,True),("forward","hash_path",2,True))
def _valid_historical_authority(manifests,serializations):
 if type(manifests)is not tuple or type(serializations)is not tuple or len(manifests)!=6 or len(serializations)!=6:return False
