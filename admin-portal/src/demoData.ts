...
export const demoOverview: AnalyticsOverview = {
  rangeDays: 30,
  totals: { questions: 1842, users: 618, tokens: 2_460_810, averageConfidence: 0.87, unanswered: 94, helpful: 486, notHelpful: 42, helpfulRate: 0.92 },
  topics: [
