...
const copy: Record<string, Partial<WidgetCopy>> = {
  en: {
    ...
    newChat: "New chat", endChat: "End chat", confirmEndChat: "End this chat", cancelEndChat: "Cancel", support: "Request support", supportQueued: "Your support request was submitted. Reference: {id}",
  ...
  fr: {
    ...
    newChat: "Nouvelle conversation", endChat: "Terminer la conversation", confirmEndChat: "Terminer ce chat", cancelEndChat: "Annuler", support: "Demander de l'aide", supportQueued: "Votre demande d'aide a été envoyée. Référence : {id}",
  ...
  es: {
    ...
    newChat: "Nuevo chat", endChat: "Finalizar chat", confirmEndChat: "Finalizar este chat", cancelEndChat: "Cancelar", support: "Solicitar ayuda", supportQueued: "Tu solicitud de ayuda fue enviada. Referencia: {id}",
  ...
  de: {
    ...
    newChat: "Neuer Chat", endChat: "Chat beenden", confirmEndChat: "Diesen Chat beenden", cancelEndChat: "Abbrechen", support: "Support anfordern", supportQueued: "Ihre Supportanfrage wurde übermittelt. Referenz: {id}",
  ...
  nl: {
    ...
    newChat: "Nieuwe chat", endChat: "Chat beëindigen", confirmEndChat: "Deze chat beëindigen", cancelEndChat: "Annuleren", support: "Hulp aanvragen", supportQueued: "Uw hulpverzoek is verzonden. Referentie: {id}",
  ...
  da: {
    ...
    newChat: "Uusi keskustelu", endChat: "Lopeta keskustelu", confirmEndChat: "Lopeta tämä keskustelu", cancelEndChat: "Peruuta", support: "Pyydä tukea", supportQueued: "Tukipyyntösi on lähetetty. Viite: {id}", supportFailed: "Tukipyyntöä ei voitu luoda. Yritä uudelleen.", supportCreating: "Luodaan...", supportRequested: "Pyydetty", conversationCleared: "Uusi keskustelu on valmis.",
  ...
  sv: {
    ...
    newChat: "Ny chatt", endChat: "Avsluta chatt", confirmEndChat: "Avsluta den här chatten", cancelEndChat: "Avbryt", support: "Begär hjälp", supportQueued: "Din supportbegäran har skickats. Referens: {id}", supportFailed: "Supportbegäran kunde inte skapas. Försök igen.", supportCreating: "Skapar...", supportRequested: "Begärd", conversationCleared: "En ny chatt är klar.",
