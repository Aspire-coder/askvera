...
const copy: Record<string, Partial<WidgetCopy>> = {
  ...
  sr: {
    greeting: "Zdravo, ja sam AskVera. Kako mogu da pomognem sa Forever Living proizvodima, pravilima ili poslovnom podrškom?",
    assistantSubtitle: "Poslovni asistent za informacije",
    welcomeEyebrow: "Dobro došli", welcomeTitle: "Zdravo, ja sam AskVera.", welcomeBody: "Mogu da vam pomognem da pronađete odobrene odgovore o Forever Living proizvodima, pravilima i poslovnoj podršci.", welcomeNext: "Izaberite tržište i jezik da biste počeli.",
