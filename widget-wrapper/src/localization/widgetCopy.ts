...
const copy: Record<string, Partial<WidgetCopy>> = {
  en: {
    greeting: "Hi, I'm AskVera. I can help you find approved answers from Forever Living company policies and the international sponsoring directory. What would you like to know?",
    assistantSubtitle: "Enterprise Knowledge Assistant",
    welcomeEyebrow: "Welcome", welcomeTitle: "Hi, I'm AskVera.",
    welcomeBody: "I can help you find approved answers from Forever Living company policies and the international sponsoring directory.",
  ...
  fr: {
    greeting: "Bonjour, je suis AskVera. Je peux vous aider à trouver des réponses approuvées dans les politiques de Forever Living et l'annuaire international de parrainage. Que souhaitez-vous savoir?",
    assistantSubtitle: "Assistant de connaissances d'entreprise",
    welcomeEyebrow: "Bienvenue", welcomeTitle: "Bonjour, je suis AskVera.",
    welcomeBody: "Je peux vous aider à trouver des réponses approuvées dans les politiques de Forever Living et l'annuaire international de parrainage.",
  ...
  es: {
    greeting: "Hola, soy AskVera. Puedo ayudarte a encontrar respuestas aprobadas en las políticas de Forever Living y el directorio internacional de patrocinio. ¿Qué deseas saber?",
    assistantSubtitle: "Asistente de conocimiento empresarial",
    welcomeEyebrow: "Bienvenido", welcomeTitle: "Hola, soy AskVera.",
    welcomeBody: "Puedo ayudarte a encontrar respuestas aprobadas en las políticas de Forever Living y el directorio internacional de patrocinio.",
  ...
  ru: {
    greeting: "Здравствуйте, я AskVera. Я помогу найти утвержденную информацию в политиках компании Forever Living и международном справочнике спонсорства. Что вы хотели бы узнать?",
    ...
    welcomeBody: "Я помогу найти утвержденную информацию в политиках компании Forever Living и международном справочнике спонсорства.",
  ...
  de: {
    greeting: "Hallo, ich bin AskVera. Ich helfe Ihnen, freigegebene Antworten in den Forever Living Unternehmensrichtlinien und im internationalen Sponsoring-Verzeichnis zu finden. Was möchten Sie wissen?",
    assistantSubtitle: "Unternehmens-Wissensassistent",
    welcomeEyebrow: "Willkommen", welcomeTitle: "Hallo, ich bin AskVera.",
    welcomeBody: "Ich helfe Ihnen, freigegebene Antworten in den Forever Living Unternehmensrichtlinien und im internationalen Sponsoring-Verzeichnis zu finden.",
  ...
  it: {
    greeting: "Ciao, sono AskVera. Posso aiutarti a trovare risposte approvate nelle politiche aziendali Forever Living e nell'elenco internazionale di sponsorizzazione. Cosa vorresti sapere?",
    assistantSubtitle: "Assistente alla conoscenza aziendale",
    welcomeEyebrow: "Benvenuto", welcomeTitle: "Ciao, sono AskVera.", welcomeBody: "Posso aiutarti a trovare risposte approvate nelle politiche aziendali Forever Living e nell'elenco internazionale di sponsorizzazione.", welcomeNext: "Scegli il mercato e la lingua per iniziare.",
  ...
  da: {
    greeting: "Hej, jeg er AskVera. Jeg kan hjælpe dig med at finde godkendte svar i Forever Livings virksomhedspolitikker og internationale sponsorkatalog. Hvad vil du gerne vide?",
    assistantSubtitle: "Virksomhedens vidensassistent",
    welcomeEyebrow: "Velkommen", welcomeTitle: "Hej, jeg er AskVera.", welcomeBody: "Jeg kan hjælpe dig med at finde godkendte svar i Forever Livings virksomhedspolitikker og internationale sponsorkatalog.", welcomeNext: "Vælg marked og sprog for at begynde.",
    ...
    greeting: "Hei, olen AskVera. Autan löytämään hyväksyttyjä vastauksia Forever Livingin yrityskäytännöistä ja kansainvälisestä sponsorointihakemistosta. Mitä haluaisit tietää?",
    assistantSubtitle: "Yrityksen tietoavustaja",
    welcomeEyebrow: "Tervetuloa", welcomeTitle: "Hei, olen AskVera.", welcomeBody: "Autan löytämään hyväksyttyjä vastauksia Forever Livingin yrityskäytännöistä ja kansainvälisestä sponsorointihakemistosta.", welcomeNext: "Valitse markkina ja kieli aloittaaksesi.",
  ...
  no: {
    greeting: "Hei, jeg er AskVera. Jeg kan hjelpe deg med å finne godkjente svar i Forever Livings selskapsretningslinjer og internasjonale sponsorkatalog. Hva vil du vite?",
    assistantSubtitle: "Kunnskapsassistent for bedriften",
    welcomeEyebrow: "Velkommen", welcomeTitle: "Hei, jeg er AskVera.", welcomeBody: "Jeg kan hjelpe deg med å finne godkjente svar i Forever Livings selskapsretningslinjer og internasjonale sponsorkatalog.", welcomeNext: "Velg marked og språk for å begynne.",
  ...
  sr: {
    greeting: "Zdravo, ja sam AskVera. Mogu da vam pomognem da pronađete odobrene odgovore u pravilima kompanije Forever Living i međunarodnom imeniku sponzorstva. Šta želite da saznate?",
    assistantSubtitle: "Poslovni asistent za informacije",
    welcomeEyebrow: "Dobro došli", welcomeTitle: "Zdravo, ja sam AskVera.", welcomeBody: "Mogu da vam pomognem da pronađete odobrene odgovore u pravilima kompanije Forever Living i međunarodnom imeniku sponzorstva.", welcomeNext: "Izaberite tržište i jezik da biste počeli.",
  ...
  sv: {
    greeting: "Hej, jag är AskVera. Jag kan hjälpa dig att hitta godkända svar i Forever Livings företagspolicyer och internationella sponsorkatalog. Vad vill du veta?",
    assistantSubtitle: "Företagets kunskapsassistent",
    welcomeEyebrow: "Välkommen", welcomeTitle: "Hej, jag är AskVera.", welcomeBody: "Jag kan hjälpa dig att hitta godkända svar i Forever Livings företagspolicyer och internationella sponsorkatalog.", welcomeNext: "Välj marknad och språk för att börja.",
