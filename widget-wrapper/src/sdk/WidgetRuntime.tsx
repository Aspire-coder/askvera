...
// This is only the pre-locale-resolution default, shown briefly before
// selectedLanguage resolves and the widgetConfig memo below replaces these
// with localized.* (the same getWidgetCopy() data, for the resolved
// locale). Deriving the English text fields from englishCopy here instead
// of retyping them keeps this default in sync with widgetCopy.ts's en
// entry - the two had already drifted apart in a couple of places (the
// consent body and decline body wording no longer matched).
const englishCopy = getWidgetCopy("en");

const baseWidgetConfig: GenericWidgetConfig = {
  brandName: "AskVera",
  assistantName: "AskVera",
  assistantSubtitle: englishCopy.assistantSubtitle,
  launcherTitle: englishCopy.openAssistant,
  footerText: englishCopy.footer,
  welcomeText: englishCopy.welcomeBody,
  loadingText: englishCopy.thinking,
  loadingMessages: {
    thinking: englishCopy.thinking,
    searching: englishCopy.searching,
    generating: englishCopy.generating,
    reconnecting: englishCopy.retrying,
    slowResponse: englishCopy.slowResponse
  },
  successText: englishCopy.privacySaved,
  labels: {
    launcherAriaLabel: "Open assistant",
    closeAriaLabel: "Minimize assistant",
    menuAriaLabel: "Open assistant menu",
    countryLabel: englishCopy.market,
    languageLabel: englishCopy.language,
    countryPlaceholder: englishCopy.selectMarket,
    languagePlaceholder: englishCopy.selectLanguage,
    continueLabel: "Continue",
    acceptConsentLabel: englishCopy.accept,
    rejectConsentLabel: englishCopy.decline,
    messageInputLabel: "Message",
    messageInputPlaceholder: englishCopy.inputPlaceholder,
    sendMessageLabel: englishCopy.send,
  ...
  menu: {
    settings: "Settings",
    history: "History",
    newChat: englishCopy.newChat,
    newChatConfirmation: englishCopy.newChatConfirmation,
    confirmNewChat: englishCopy.confirmNewChat,
    cancelNewChat: englishCopy.cancelNewChat,
    escalate: "Contact support"
  },
  consent: {
    title: englishCopy.privacyTitle,
    body: englishCopy.privacyBody,
    eyebrow: englishCopy.privacyEyebrow,
    acknowledgmentLabel: englishCopy.privacyAcknowledgment,
    loadingText: englishCopy.privacyLoading,
    declineTitle: englishCopy.declineTitle,
    declineBody: englishCopy.declineBody,
    declineActionLabel: englishCopy.reviewPrivacy,
      ...
      content: (
        <SupportRequestForm
          labels={{
            ...
            submitting: localized.supportCreating,
