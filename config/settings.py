...
# These controls apply only to the isolated vNext provider. They intentionally
# do not reuse the primary OpenSearch flags so an experiment cannot change the
# user-visible retrieval path merely because shadow mode is enabled.
RETRIEVAL_VNEXT_RESULT_COUNT = _env_int("RETRIEVAL_VNEXT_RESULT_COUNT", 8)
RETRIEVAL_VNEXT_GLOSSARY_ENABLED = _env_bool("RETRIEVAL_VNEXT_GLOSSARY_ENABLED", False)
...
RETRIEVAL_VNEXT_CANDIDATE_PARENT_QUOTA_ENABLED = _env_bool(
    "RETRIEVAL_VNEXT_CANDIDATE_PARENT_QUOTA_ENABLED",
    False,
)
RETRIEVAL_VNEXT_NEIGHBOR_EXPANSION_ENABLED = _env_bool(
