...
PROMPT_VERSION = _env_str("PROMPT_VERSION", "2026-09-25-income-disclaimer-exact-sentence-v7")
...
RISK_INPUT_MAX_CHARS = _env_int("RISK_INPUT_MAX_CHARS", 25000)
...
PII_CIRCUIT_BREAKER_FAILURE_THRESHOLD = _env_int("PII_CIRCUIT_BREAKER_FAILURE_THRESHOLD", 3)
PII_CIRCUIT_BREAKER_RESET_SECONDS = _env_int("PII_CIRCUIT_BREAKER_RESET_SECONDS", 30)
...
PLANNER_TRUSTED_THANKS_MIN_CONFIDENCE = _env_float("PLANNER_TRUSTED_THANKS_MIN_CONFIDENCE", 0.9)
PLANNER_TRUSTED_THANKS_MAX_WORDS = _env_int("PLANNER_TRUSTED_THANKS_MAX_WORDS", 12)
...
OPENSEARCH_RETRIEVAL_SCORING_RULES_PATH = _env_str(
    "OPENSEARCH_RETRIEVAL_SCORING_RULES_PATH",
    str(Path(__file__).with_name("retrieval_scoring_rules.json")),
)
