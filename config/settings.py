...
# Candidate-only ranking controls. These are consumed only by the isolated
# vNext provider. The current provider continues to use the established live
# flags below so enabling Shadow cannot change a customer response.
RETRIEVAL_VNEXT_RRF_ENABLED = _env_bool("RETRIEVAL_VNEXT_RRF_ENABLED", False)
RETRIEVAL_VNEXT_PARENT_DIVERSITY_ENABLED = _env_bool(
    "RETRIEVAL_VNEXT_PARENT_DIVERSITY_ENABLED",
    False,
)
RETRIEVAL_VNEXT_AUTHORITY_RANKING_ENABLED = _env_bool(
    "RETRIEVAL_VNEXT_AUTHORITY_RANKING_ENABLED",
    False,
)
RETRIEVAL_VNEXT_PARENT_CHILD_ENABLED = _env_bool(
    "RETRIEVAL_VNEXT_PARENT_CHILD_ENABLED",
    False,
)
RETRIEVAL_VNEXT_SIGNAL_CONFIDENCE_ENABLED = _env_bool(
    "RETRIEVAL_VNEXT_SIGNAL_CONFIDENCE_ENABLED",
    False,
)
RETRIEVAL_VNEXT_TARGET_MARKET_GUARD_ENABLED = _env_bool(
    "RETRIEVAL_VNEXT_TARGET_MARKET_GUARD_ENABLED",
    False,
)
RETRIEVAL_VNEXT_EVIDENCE_SELECTOR_ENABLED = _env_bool(
    "RETRIEVAL_VNEXT_EVIDENCE_SELECTOR_ENABLED",
    False,
)
RETRIEVAL_VNEXT_HARDENING_ENABLED = _env_bool(
...
RETRIEVAL_AUTHORITY_RANKING_ENABLED = _env_bool("RETRIEVAL_AUTHORITY_RANKING_ENABLED", False)
RETRIEVAL_PARENT_CHILD_ENABLED = _env_bool("RETRIEVAL_PARENT_CHILD_ENABLED", False)
RETRIEVAL_PARENT_CHILD_LIMIT = _env_int("RETRIEVAL_PARENT_CHILD_LIMIT", 2)
RETRIEVAL_SIGNAL_CONFIDENCE_ENABLED = _env_bool("RETRIEVAL_SIGNAL_CONFIDENCE_ENABLED", False)
RETRIEVAL_TARGET_MARKET_GUARD_ENABLED = _env_bool("RETRIEVAL_TARGET_MARKET_GUARD_ENABLED", False)
