...
OPENSEARCH_QUERY_REWRITE_ENABLED = _env_bool("OPENSEARCH_QUERY_REWRITE_ENABLED", False)
OPENSEARCH_QUERY_REWRITE_COUNT = _env_int("OPENSEARCH_QUERY_REWRITE_COUNT", 4)
